/****************************************************************************
** Meta object code from reading C++ file 'preview_widget.h'
**
...
#include "../../../include/gui/preview_widget.h"
...
#error "The header file 'preview_widget.h' doesn't include <QObject>."
...
void PreviewWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->onFrameReceived((*reinterpret_cast< std::add_pointer_t<QImage>>(_a[1]))); break;
        default: ;
        }
    }
}
